...
const userAgents = [
    ...
    'Mozilla/5.0 (Linux; Android 9; Pixel 3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.72 Mobile Safari/537.36',
            ...
            try {
                ...
                */
                ...
                if (links.length > 1) {
                    ...
                    console.log(`Klikam losowy link: ${linkHref}`);
                    await randomLink.click();
                    await page.waitForTimeout(8000);
                } else if (links.length === 1) {
                    const linkHref = await links[0].getAttribute('href');
                    console.log(`Klikam jedyny link na stronie: ${linkHref}`);
                    await links[0].click();
                    await page.waitForTimeout(8000);
                } else {
